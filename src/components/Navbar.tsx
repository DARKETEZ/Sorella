          ...
          >
            <div className="mx-auto grid max-w-7xl gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <a onClick={closeMenu} href="https://wa.me/50375209639" target="_blank" rel="noopener noreferrer" className="rounded-2xl bg-sorella-red px-4 py-3 text-center text-sm font-black text-white">WhatsApp</a>
